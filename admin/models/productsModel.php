<?php 
	trait ProductsModel{
		...
		public function modelUpdate($id){
			...
			//lay bien ket noi csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("update products set name=:var_name,description=:var_description,category_id=:var_category_id,discount=:var_discount where id=:var_id");
			//thuc thi truy van, truyen tham so
			$query->execute(["var_id"=>$id,"var_name"=>$name,"var_description"=>$description,"var_category_id"=>$category_id,"var_discount"=>$discount]);
		...
		public function modelCreate(){
			...
			//lay bien ket noi csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("insert into products set photo=:var_photo,name=:var_name,description=:var_description,category_id=:var_category_id,discount=:var_discount");
			//thuc thi truy van, truyen tham so
			$query->execute(["var_photo"=>$photo,"var_name"=>$name,"var_description"=>$description,"var_category_id"=>$category_id,"var_discount"=>$discount]);	
		}
	}
 ?>